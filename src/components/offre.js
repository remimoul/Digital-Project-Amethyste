...
function Offre(){
    ...
    <div className="flex flex-col justify-center items-center self-stretch mt-12">
        ...
        <span className='font-bold'>Notre offre </span>: Abonnement mensuel pour un accès de base à l’application.<br></br> 
        <span className='font-bold'>Inclus</span> : exercices de gestion du stress, journal de bord, notifications push, outils d’évaluation du bien-être, espaces de communication.
        </p>
...
<br></br>
À ce “pack de base”, peuvent s’ajouter des extensions payantes pour les entreprises qui auraient besoin ou envie de bénéficier de services supplémentaires.       
</span>
...
<p className='font-inter text-lg mb-8'> <span className=' font-bold'>Tarif de base </span>: <span className='text-red-600 font-bold'>800€</span> par événement.</p>
<div className='md:mx-40 mx-6'>
<p className='font-inter text-lg'>Ce tarif inclut l'organisation d'un team buildings ou d'un afterworks pour une durée de 2 à 3 heures,<br></br> avec des activités de groupe, des rafraîchissements et des collations pour un groupe d'environ 20 à 50 personnes.<br></br>
Des frais supplémentaires peuvent s'appliquer pour des groupes plus nombreux, des activités spéciales, des lieux de prestige ou des options de restauration haut de gamme.</p>
        </div>
...
<p className='font-inter text-lg mb-8'> <span className=' font-bold'>Tarif de base </span>: <span className='text-red-600 font-bold'>1500€</span> par événement.</p>
<div className='md:mx-40 mx-6'>
<p className='font-inter text-lg mb-20'>Ce tarif inclut l'intervention d'un professionnel de la santé mentale (partenaire avec GRINEASY) au sein de l'entreprise cliente pour une session de consultation d'une demi-journée, comprenant des conseils personnalisés, des ateliers interactifs et des ressources pour les employés.

Des frais supplémentaires peuvent s'appliquer pour des interventions plus longues, des programmes de formation sur mesure ou des suivis individuels.</p>
        </div>
